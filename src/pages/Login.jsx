...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // For login, save the token and username
      if (!isSignup) {
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg w-80">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="bg-blue-600 hover:bg-blue-700 text-white py-2 rounded flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading && (
